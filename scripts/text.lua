...
local Texts = {
	...
	Tut_Reflex_Text = "The Hive Warrior's biocannon can only fire once a turn (without upgrades). Use this to draw it's fire with high HP mechs!",

	Tut_Bearer_Title = "Pod Collected",
	Tut_Bearer_Text = "This mech has the Time Pod in tow. If it is killed, the Time Pod's contents will be lost!",

	Tut_Freeze_Title = "Temporary Freeze",
	Tut_Freeze_Text = "The Hive Warrior will break out of the ice at the start of the next player turn.",
